...
public class DestinationFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String destinationName = requireArguments().getString("destination_name");
        String destinationDescription = requireArguments().getString("destination_description");
        int destinationImage = requireArguments().getInt("destination_image");

        TextView destinationNameTextView = view.findViewById(R.id.fragmentNameTextView);
